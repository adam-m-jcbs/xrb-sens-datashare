...
class RemoteClientCycleHooks(CycleHooks):
    ...
    add_pre_hook     = server_add_pre_hook
    add_post_hook    = server_add_post_hook
    clear_pre_hooks  = server_clear_pre_hooks
    clear_post_hooks = server_clear_post_hooks
    clear_hooks      = server_clear_hooks
