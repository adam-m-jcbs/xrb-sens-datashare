...
# c.TerminalInteractiveShell.banner1 = 'Python 2.7.3 (default, Aug  9 2012, 17:23:57) \nType "copyright", "credits" or "license" for more information.\n\nIPython 0.13.2 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
...
try:
    source = os.path.dirname(os.path.join(os.path.dirname(__file__), os.readlink(__file__)))
except:
    source = os.path.expanduser('~/python/source')
...
#     c.InteractiveShellApp.exec_lines.append('%pylab nbagg')
# c.InteractiveShellApp.exec_lines.append('%pylab')
...
c.InteractiveShellApp.exec_lines.append('%aimport -fortranfile')

startupfile = os.path.join(source, 'autoreload')
if os.path.isfile(startupfile):
    with open(startupfile, 'rt') as f:
        for line in f:
            if line.strip() != '':
                c.InteractiveShellApp.exec_lines.append('%aimport '+line)

filename = os.environ.get('PYTHONSTARTUP')
if filename and os.path.isfile(filename):
    c.InteractiveShellApp.exec_files = [filename]
